...
public class StreamTest3_중간처리2 {
	...
	public static void main(String[] args) {
		...
		List<Student2> list2 = Arrays.asList(new Student2("홍길동", 100), new Student2("이순신", 90), new Student2("유관순", 50),
				new Student2("강감찬", 70), new Student2("정조", 95), new Student2("선덕여왕", 45));
		...
		list2.stream().sorted(Comparator.comparing(f)) // 오름차순
				.forEach(System.out::println);
		System.out.println("===============================");

		list2.stream().sorted(Comparator.comparing(f, Comparator.reverseOrder())) // 내림차순
				.forEach(System.out::println);
		System.out.println("===============================");
